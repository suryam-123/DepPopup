...
/* 
        *   File: depmultiinfo_Entry_Web.module.ts
        ...
        */
        ...
        import {depmultiinfo_Entry_Web} from './depmultiinfo_Entry_Web';           
        ...
        const routes: Routes = [
            {
            path: '',
            component: depmultiinfo_Entry_Web
            }
        ];
            ...
            imports: [
                ...
                declarations:[depmultiinfo_Entry_Web]
                })
                export class depmultiinfo_Entry_Webmodule{}