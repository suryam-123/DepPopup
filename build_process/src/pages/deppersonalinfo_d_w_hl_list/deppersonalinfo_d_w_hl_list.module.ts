...
/* 
        *   File: deppersonalinfo_d_w_hl_list.module.ts
        ...
        */
        ...
        import {deppersonalinfo_d_w_hl_list} from './deppersonalinfo_d_w_hl_list';           
        ...
        const routes: Routes = [
            {
            path: '',
            component: deppersonalinfo_d_w_hl_list
            }
        ];
            ...
            imports: [
                ...
                declarations:[deppersonalinfo_d_w_hl_list]
                })
                export class deppersonalinfo_d_w_hl_listmodule{}