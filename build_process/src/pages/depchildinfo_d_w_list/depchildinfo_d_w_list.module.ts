...
/* 
        *   File: depchildinfo_d_w_list.module.ts
        ...
        */
        ...
        import {depchildinfo_d_w_list} from './depchildinfo_d_w_list';           
        ...
        const routes: Routes = [
            {
            path: '',
            component: depchildinfo_d_w_list
            }
        ];
            ...
            imports: [
                ...
                declarations:[depchildinfo_d_w_list]
                })
                export class depchildinfo_d_w_listmodule{}