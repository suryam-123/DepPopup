...
/* 
        *   File: depmultiinfo_d_w_list.module.ts
        ...
        */
        ...
        import {depmultiinfo_d_w_list} from './depmultiinfo_d_w_list';           
        ...
        const routes: Routes = [
            {
            path: '',
            component: depmultiinfo_d_w_list
            }
        ];
            ...
            imports: [
                ...
                declarations:[depmultiinfo_d_w_list]
                })
                export class depmultiinfo_d_w_listmodule{}