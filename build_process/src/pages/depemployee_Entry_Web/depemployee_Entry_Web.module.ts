...
/* 
        *   File: depemployee_Entry_Web.module.ts
        ...
        */
        ...
        import {depemployee_Entry_Web} from './depemployee_Entry_Web';           
        ...
        const routes: Routes = [
            {
            path: '',
            component: depemployee_Entry_Web
            }
        ];
            ...
            imports: [
                ...
                declarations:[depemployee_Entry_Web]
                })
                export class depemployee_Entry_Webmodule{}