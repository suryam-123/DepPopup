...
@Component({
    selector: 'depemployee_d_w_list',
    templateUrl: 'depemployee_d_w_list.html'
}) export class depemployee_d_w_list implements OnInit {
    ...
    constructor(public angularUtilService: AngularUtilService, public objMapping: objectTableMapping, public objectTableMappingObject: objectTableMapping, public gridIdConfig: cspfmGridsectionListIdConfiguration, public dialog: MatDialog, public observableListenerUtils: cspfmObservableListenerUtils,
        ...
        this.appUtilityConfig.initialHiddenColumns(this.columnDefinitions, this.__depemployee$tableName);
        ...
        this.listenerName = this.slickgridUtils.subscribeLazyLoading(
            ...
            this.layoutId,
            getAngularGrid,
            this.columnDefinitions[this.__depemployee$tableName]
        );
        ...
        if (this.sectionObjectDetails[this.__depemployee$tableName]['isMatrixEnabled'] === true || this.upsertHeaderFlag === true || this.isMailActionAvailable === true || this.isWorkflowActionAvailable === true) {
        ...
        this.appUtilityConfig.setColumnWidth(this.columnDefinitions[this.__depemployee$tableName]);
    ...
    public filterSectionDetail: FilterSectionDetail = {
        filterFields: {
            ...
            "pfm71655_team_7773874": {
                ...
                "displayInfo": {
                    "input": [{
                        "label": "depemployee.team.Option.Innovation Squad",
                        "isChecked": false,
                        "value": "IS"
                    }, {
                        "label": "depemployee.team.Option.appConnect",
                        "isChecked": false,
                        "value": "AC"
                    }, {
                        "label": "depemployee.team.Option.Testing",
                        "isChecked": false,
                        "value": "TE"
                    }],
                    "selected": [],
    ...
    public layoutId = "203850";
    public layoutName = "depemployee_d_w_list";
    ...
    public gridId = 'cspfm_grid_' + this.layoutId + '_' + this.__depemployee$tableName;
    public gridContainerId = 'cspfm_grid_container_' + this.layoutId + '_' + this.__depemployee$tableName;
    public matrixGridId = 'cspfm_matrix_grid_' + this.layoutId + '_' + this.__depemployee$tableName;
    public matrixGridContainerId = 'cspfm_matrix_grid_container_' + this.layoutId + '_' + this.__depemployee$tableName;
    public __COR_USERS$tableName = this.objectTableMappingObject.mappingDetail['COR_USERS'];
    public team_930536_7773874 = this.pfmObjectConfig.objectConfiguration[this.__depemployee$tableName]['selectionFieldsMapping']['team'];
    public team_930536_7773867 = this.pfmObjectConfig.objectConfiguration[this.__depemployee$tableName]['selectionFieldsMapping']['team'];
    ...
    public tableColumnInfo = {
        [this.__depemployee$tableName]: {
            "pfm71655_employeeid_7773865": {
                "id": "employeeid",
                "label": "depemployee_d_w_list.Element.depemployee_DUMMY$$employeeid.employeeid",
                "fieldName": "employeeid",
                "prop": "employeeid",
                "fieldType": "TEXT",
                "objectName": "depemployee",
            ...
            "pfm71655_employeename_7773869": {
                "id": "employeename",
                "label": "depemployee_d_w_list.Element.depemployee_DUMMY$$employeename.employeename",
                "fieldName": "employeename",
                "prop": "employeename",
                "fieldType": "TEXT",
                "objectName": "depemployee",
            ...
            "pfm71655_team_7773867": {
                "id": "team",
                "label": "depemployee_d_w_list.Element.depemployee_DUMMY$$team.team",
                "fieldName": "team",
                "prop": "team",
                "fieldType": "DROPDOWN",
                "objectName": "depemployee",
                ...
                "child": "",
                "dateFormat": "",
                "mappingDetails": this.team_930536_7773867,
                "currencyDetails": "",
                "boxStyle": "",
                "valueStyle": ""
            },
            "pfm71655_cspfmaction7773868": {
                "id": "cspfmaction7773868",
                "label": "depemployee_d_w_list.Action.Edit_1",
                "fieldName": "cspfmaction7773868",
                "prop": "cspfmaction7773868",
                "elementid": 7773868,
                "elementType": "ACTION",
                "child": "",
                "dateFormat": "",
                ...
                "actionInfo": [{
                    ...
                    "actionType": "EDIT",
                    "sourceId": "7773868",
                    "traversalpath": "depemployee_d_w_list_Edit_1",
                    ...
                    "valueStyle": "",
                    "navigationInfo": {
                        "navigationUrl": "depemployee_Entry_Web",
                        "redirectUrl": "depemployee_d_w_list",
                        "uniqueKey": "id",
                        "enablePopUp": false,
                        "webserviceinfo": [],
                        "relationalObjectInfo": {
                            "relationalObjectName": "depemployee",
                            "relationalObjectId": "",
    ...
    public columnDefinitions: {
        ...
        [this.__depemployee$tableName]: [{
            id: this.tableColumnInfo[this.__depemployee$tableName]['pfm71655_employeeid_7773865']['id'],
            nameKey: lodash.escape(this.translateService.instant(this.tableColumnInfo[this.__depemployee$tableName]['pfm71655_employeeid_7773865']['label'])),
            field: this.tableColumnInfo[this.__depemployee$tableName]['pfm71655_employeeid_7773865']['prop'],
            toolTip: this.slickgridUtils.convertSplCharToEntities(this.translateService.instant(this.tableColumnInfo[this.__depemployee$tableName]['pfm71655_employeeid_7773865']['label']), 'fromEntity'),
            sortable: true,
            ...
            grouping: < cspfmDataGrouping > {
                getter: (data) => {
                    return this.slickgridUtils.getter(data, this.tableColumnInfo[this.__depemployee$tableName]['pfm71655_employeeid_7773865'])
                },
                formatter: (groupingFormatterItem: GroupingFormatterItem) => {
                    return this.slickgridUtils.formatter(groupingFormatterItem, this.tableColumnInfo[this.__depemployee$tableName]['pfm71655_employeeid_7773865']['label'])
                },
                params: {
                    id: this.tableColumnInfo[this.__depemployee$tableName]['pfm71655_employeeid_7773865']['id']
                },
            ...
            params: {
                ...
                fieldInfo: this.tableColumnInfo[this.__depemployee$tableName]['pfm71655_employeeid_7773865'],
            ...
            id: this.tableColumnInfo[this.__depemployee$tableName]['pfm71655_employeename_7773869']['id'],
            nameKey: lodash.escape(this.translateService.instant(this.tableColumnInfo[this.__depemployee$tableName]['pfm71655_employeename_7773869']['label'])),
            field: this.tableColumnInfo[this.__depemployee$tableName]['pfm71655_employeename_7773869']['prop'],
            toolTip: this.slickgridUtils.convertSplCharToEntities(this.translateService.instant(this.tableColumnInfo[this.__depemployee$tableName]['pfm71655_employeename_7773869']['label']), 'fromEntity'),
            sortable: true,
            type: FieldType.string,
            ...
            grouping: < cspfmDataGrouping > {
                getter: (data) => {
                    return this.slickgridUtils.getter(data, this.tableColumnInfo[this.__depemployee$tableName]['pfm71655_employeename_7773869'])
                },
                formatter: (groupingFormatterItem: GroupingFormatterItem) => {
                    return this.slickgridUtils.formatter(groupingFormatterItem, this.tableColumnInfo[this.__depemployee$tableName]['pfm71655_employeename_7773869']['label'])
                },
                params: {
                    id: this.tableColumnInfo[this.__depemployee$tableName]['pfm71655_employeename_7773869']['id']
                },
            ...
            params: {
                ...
                required: false,
                pipe: this.cspfmDataDisplay,
                fieldInfo: this.tableColumnInfo[this.__depemployee$tableName]['pfm71655_employeename_7773869'],
                layoutId: this.layoutId
            ...
            id: this.tableColumnInfo[this.__depemployee$tableName]['pfm71655_team_7773867']['id'],
            nameKey: lodash.escape(this.translateService.instant(this.tableColumnInfo[this.__depemployee$tableName]['pfm71655_team_7773867']['label'])),
            field: this.tableColumnInfo[this.__depemployee$tableName]['pfm71655_team_7773867']['prop'],
            toolTip: this.slickgridUtils.convertSplCharToEntities(this.translateService.instant(this.tableColumnInfo[this.__depemployee$tableName]['pfm71655_team_7773867']['label']), 'fromEntity'),
            sortable: true,
            type: FieldType.string,
            ...
            // minWidth: this.columnMinWidth,
            formatter: CspfmDataFormatter,
            queryField: this.tableColumnInfo[this.__depemployee$tableName]['pfm71655_team_7773867']['prop'] + appConstant['customFieldSuffix']['slickgrid'],
            filterable: true,
            filter: {
                collection: this.slickgridUtils.getLabelValue(this.tableColumnInfo[this.__depemployee$tableName]['pfm71655_team_7773867']['mappingDetails']),
            ...
            grouping: < cspfmDataGrouping > {
                getter: (data) => {
                    return this.slickgridUtils.getter(data, this.tableColumnInfo[this.__depemployee$tableName]['pfm71655_team_7773867'])
                },
                formatter: (groupingFormatterItem: GroupingFormatterItem) => {
                    return this.slickgridUtils.formatter(groupingFormatterItem, this.tableColumnInfo[this.__depemployee$tableName]['pfm71655_team_7773867']['label'])
                },
                params: {
                    id: this.tableColumnInfo[this.__depemployee$tableName]['pfm71655_team_7773867']['id']
                },
            ...
            params: {
                ...
                required: false,
                pipe: this.cspfmDataDisplay,
                fieldInfo: this.tableColumnInfo[this.__depemployee$tableName]['pfm71655_team_7773867'],
                layoutId: this.layoutId
            ...
            id: this.tableColumnInfo[this.__depemployee$tableName]['pfm71655_cspfmaction7773868']['id'],
            nameKey: lodash.escape(this.translateService.instant(this.tableColumnInfo[this.__depemployee$tableName]['pfm71655_cspfmaction7773868']['label'])),
            field: this.tableColumnInfo[this.__depemployee$tableName]['pfm71655_cspfmaction7773868']['prop'],
            toolTip: this.slickgridUtils.convertSplCharToEntities(this.translateService.instant(this.tableColumnInfo[this.__depemployee$tableName]['pfm71655_cspfmaction7773868']['label']), 'fromEntity'),
            sortable: false,
            ...
            columnGroupKey: 'depemployee_d_w_list.Action.Edit_1',
            ...
            params: {
                ...
                actionInfo: this.tableColumnInfo[this.__depemployee$tableName]['pfm71655_cspfmaction7773868']['actionInfo'],
            ...
            onCellClick: (mouseEvent, args) => {
                this.onActionCellClick(mouseEvent, args, this.__depemployee$tableName);
            },
    ...
    public gridOptions: GridOption = {
        ...
        presets: {
            sorters: [{
                columnId: this.tableColumnInfo['pfm71655']['pfm71655_employeeid_7773865']['prop'],
                direction: 'ASC'
            }],
        },
    ...
    clearMessageConfirmAlert(startOverAllFetch ? ) {
        ...
        if (this.filterSectionDetail['filterPanelExpanded'] && this.filterSectionDetail['filterAppliedFields'].length === 0) {
            ...
            if (!searchFieldHasValue) {
                ...
                for (let object of Object.keys(this.filterSectionDetail['filterFields'])) {
                    this.cspfmListFilter.clearFilterAppliedField(this.filterSectionDetail['filterFields'][object], false);
                }
    ...
    async filterAction() {
        ...
        if (this.sectionObjectDetails[this.__depemployee$tableName]['matrixConfig']['displayInfo']['currentMode'] === 'matrix') {
        ...
        if (msg === 'success') {
            ...
            if (querySelector) {
                ...
                if (this.dataSource === appConstant.pouchDBStaticName) {
                    ...
                    let query = "type:" + this.tableName_pfm71655
        ...
        if (Object.keys(this.layoutCriteriaQueryConfig).length > 0 && this.layoutCriteriaQueryConfig['operands']) {
            ...
            if ((this.layoutDataRestrictionSet.length > 0 && this.layoutDataRestrictionSet[0]['restrictionType'] === "userAssignment") || (this.layoutCriteriaQueryConfig['relationalObjects'] && this.layoutCriteriaQueryConfig['relationalObjects'].length > 0)) {
                const layoutDataRestrictionSet = {
                    ...
                    "junctionDataObjects": {},
                    "searchQuery": "",
                    "objectName": this.__depemployee$tableName
                }
    ...
    checkChangedListenerData(idArrayToFetch) {
        const prefix = this.__depemployee$tableName + "_2_";
    ...
    callAddingChangeListerDataBasedOnFetchMode(idArrayToFetch) {
        ...
        if (removeOldIds.length > 0) this.liveListenerHandlerUtils.modifiedBulkDocs(removeOldIds, this.angularGrid, this.__depemployee$tableName, this.filteredResultList, this.gridSearchRowToggle, this.filterSectionDetail)
    ...
    filterFetch(methodCalledBy: 'filter' | 'listener') {
        ...
        if (reverseHierarchyKeys.length === 1 && reverseHierarchyKeys.indexOf('depemployee_DUMMY') > -1 && (!queryReverseHierarchy['depemployee_DUMMY']['options_rollup'])) {
            if (methodCalledBy === 'filter') {
                if (this.batchWiseIdArray.length > 0 && ((this.layoutDataRestrictionSet.length > 0 && this.layoutDataRestrictionSet[0]['restrictionType'] === "userAssignment") || (this.layoutCriteriaQueryConfig['relationalObjects'] && this.layoutCriteriaQueryConfig['relationalObjects'].length > 0)) && this.dataFetchMode === 'OnClickBatch') {
                    let taskList = [];
                    let searchListQuery = queryReverseHierarchy['depemployee_DUMMY']['options'];
                    ...
                    this.filterResponse(queryReverseHierarchy['depemployee_DUMMY']['options'] + ' AND _id : ( null )');
                } else {
                    this.filterResponse(queryReverseHierarchy['depemployee_DUMMY']['options']);
                }
            } else if (methodCalledBy === 'listener') {
                fetchParams['searchListQuery'] = queryReverseHierarchy['depemployee_DUMMY']['options']
                if (queryReverseHierarchy['depemployee_DUMMY']['modifiedId']) {
                    fetchParams['searchListQuery'] = fetchParams['searchListQuery'] + ' AND id:' + queryReverseHierarchy['depemployee_DUMMY']['modifiedId'];
                }
                this.handleListener(fetchParams, false)
            }
        } else {
            this.dbService.getObjectIdsBasedOnFilterQuery(queryReverseHierarchy, this.__depemployee$tableName).then(result => {
                let searchListQuery = ""
                if (Array.isArray(result) && result && result.length > 0) {
                    if (reverseHierarchyKeys.indexOf('depemployee_DUMMY') > -1 && queryReverseHierarchy['depemployee_DUMMY'] && queryReverseHierarchy['depemployee_DUMMY']['options']) {
                        searchListQuery = queryReverseHierarchy['depemployee_DUMMY']['options'];
                    } else {
                        searchListQuery = "type : " + this.__depemployee$tableName;
                    }
                    let tempResult = [];
                    ...
                    if (methodCalledBy === 'filter' && tempResult.length > 0) {
                        ...
                        searchListQuery = "type : " + this.__depemployee$tableName + " AND _id : ( null )";
                    }
                    ...
                    if (methodCalledBy === 'filter') {
                        ...
                        this.batchWiseIdArrayTemp = [];
                        if (reverseHierarchyKeys.indexOf('depemployee_DUMMY') > -1 && queryReverseHierarchy['depemployee_DUMMY'] && queryReverseHierarchy['depemployee_DUMMY']['options']) {
                            searchListQuery = queryReverseHierarchy['depemployee_DUMMY']['options'] + "AND _id : ( null )";
                        } else {
                            searchListQuery = "type : " + this.__depemployee$tableName + "AND _id : (null)";
                        }
                        this.filterResponse(searchListQuery);
            ...
            if (searchQuery) {
                ...
                if (this.batchWiseIdArray.length > 0) {
                    if (this.dataFetchMode === 'OnClickBatch') {
                        ...
                        if (this.resultCount === this.pagination['total_rows']) {
                            fetchParams['searchListQuery'] = "type:" + this.__depemployee$tableName + " AND _id : ( " + this.batchWiseIdArray[0].join(" OR ") + " )"
                            this.resultCount = 0;
                            this.batchWiseIdArray.shift();
                            fetchParams['pagination']['bookmark'] = "";
                        } else {
                            fetchParams['searchListQuery'] = "type:" + this.__depemployee$tableName + " AND _id : ( " + this.batchWiseIdArrayTemp[this.batchWiseIdArrayTemp.length - this.batchWiseIdArray.length - 1].join(" OR ") + " )"
                        }
                    }
                } else if (this.batchWiseIdArray.length === 0 && this.batchWiseIdArrayTemp.length > 0) {
                    fetchParams['searchListQuery'] = "type:" + this.__depemployee$tableName + " AND _id : ( " + this.batchWiseIdArrayTemp[this.batchWiseIdArrayTemp.length - 1].join(" OR ") + " )"
                } else {
                    fetchParams['searchListQuery'] = "type:" + this.__depemployee$tableName
                }
            }
        }
        ...
        return this.dataProvider.fetchDataFromDataSource(fetchParams).then(res => {
            ...
            if (res['status'] === 'SUCCESS') {
                ...
                if (res['records'].length > 0) {
                    ...
                    res['records'] = this.cspfmCustomFieldProvider.makeSlickGridCustomFields(res['records'], this.columnDefinitions[this.__depemployee$tableName])
                    if (this.dataFetchMode === 'OnClickBatch') {
    ...
    async onActionCellClick(mouseEvent: KeyboardEvent | MouseEvent, args: OnEventArgs, objectName ? ) {
        ...
        if (actionView && actionInfoValue && actionView === 'button') {
            ...
            this.slickgridUtils.onItemTap(data, "/menu/depemployee_d_w_view", "/menu/depemployee_d_w_list", false, [], this.inlineEditBoolObj);
        }
    }
    ...
    angularGridReady(angularGrid: AngularGridInstance) {
        ...
        this.gridObj['cspfm_grid_custom_data'] = {
            "page_title_key": "depemployee_d_w_list.Layout.depemployee_d_w_list",
        ...
        if (this.groupingColumns.length > 0) {
            this.slickgridUtils.setInitialGrouping(this.tableName_pfm71655, this.gridObj, this.groupingColumns, this.tableColumnInfo, this.draggableGroupingPlugin)
    ...
    async handleResult(result) {
        ...
        if (result && result['status'] && result['records'] && (result['status'] === 'SUCCESS' || result['records'].length > 0)) {
            ...
            this.angularGrid["slickGrid"]['isAutoFitEnable'] = this.sectionObjectDetails[this.__depemployee$tableName].isAutoFitEnable
            setTimeout(() => {
                ...
                if (this.filterSectionDetail.reverseHierarchy[modifiedObjectType.hierarchyJson.rootPath]) {
                    ...
                    if (filterHierarchyJson.options !== '') {
                        ...
                        if (this.modifiedSet && this.modifiedSet.length > 0) {
                            ...
                            fetchParams['searchListQuery'] = "type: " + this.__depemployee$tableName + " AND _id : ( " + queryModifiedIds.join(" OR ") + " ) "
                        } else if (modifiedObjectType['objectType'] === 'PRIMARY') {
                            if (!(modified['doc']['_id'].includes('rollup') || modified['doc']['_id'].includes('formula'))) {
                                fetchParams['searchListQuery'] = "type: " + this.__depemployee$tableName + " AND _id: " + modified['doc']['_id'];
                            }
                        }
                        this.handleListener(fetchParams, false)
                    }
    ...
    addingChangeListerDataBasedOnFetchMode(formattedId) {
        ...
        if (this.dataFetchMode === 'OnClickBatch') {
            ...
            if (removeOldIds && removeOldIds.length > 0) {
                this.liveListenerHandlerUtils.modifiedBulkDocs(removeOldIds, this.angularGrid, this.__depemployee$tableName, this.filteredResultList, this.gridSearchRowToggle, this.filterSectionDetail);
    ...
    fetchListenedRecords(idArrayToFetch) {
        ...
        Promise.all(taskList).then(result => {
            ...
            this.liveListenerHandlerUtils.upsertModifiedData(finalResult, this.angularGrid, this.columnDefinitions, this.__depemployee$tableName, this.sectionObjectDetails, this.isLoading, this.dataSource, this.filteredResultList, this.gridSearchRowToggle, this.filterSectionDetail);
        })
    }
    ...
    fetchByBulkIds(queryParam, idArrayToFetch) {
        let formattedId = idArrayToFetch.map(id => {
            if (id.includes("pfm")) {
                ...
                return this.tableName_pfm71655 + "_2_" + id;
            }
        }).join(" ");
        if (this.searchQueryForDesignDoc) {
            queryParam['searchListQuery'] = this.searchQueryForDesignDoc + " AND id:" + "(" + formattedId + ")";
        } else {
            queryParam['searchListQuery'] = "type:" + this.tableName_pfm71655 + " AND id:" + "(" + formattedId + ")";
        }
        return this.dataProvider.fetchDataFromDataSource(queryParam).then(result => {
            ...
            if (result['records'].length === 0) {
                this.liveListenerHandlerUtils.modifiedBulkDocs(idArrayToFetch, this.angularGrid, this.__depemployee$tableName, this.filteredResultList, this.gridSearchRowToggle, this.filterSectionDetail)
                return
            }
            this.liveListenerHandlerUtils.upsertModifiedData(result['records'], this.angularGrid, this.columnDefinitions, this.__depemployee$tableName, this.sectionObjectDetails, this.isLoading, this.dataSource, this.filteredResultList, this.gridSearchRowToggle, this.filterSectionDetail);
    ...
    async fetchModifiedRec(modifiedDataId) {
        ...
        modifiedDataId = modifiedDataId.includes(this.tableName_pfm71655 + "_2_") ? modifiedDataId : this.tableName_pfm71655 + "_2_" + modifiedDataId
        if (this.searchQueryForDesignDoc) {
            fetchParams['searchListQuery'] = this.searchQueryForDesignDoc + " AND id:" + modifiedDataId;
        } else {
            fetchParams['searchListQuery'] = "type:" + this.tableName_pfm71655 + " AND id:" + modifiedDataId;
        }
        this.dataProvider.fetchDataFromDataSource(fetchParams).then(result => {
            ...
            if (result['records'].length === 0) {
                this.liveListenerHandlerUtils.modifiedDataSet(this.angularGrid, modifiedDataId, this.__depemployee$tableName, this.filteredResultList, this.gridSearchRowToggle)
                return
            }
            this.liveListenerHandlerUtils.upsertModifiedData(result['records'], this.angularGrid, this.columnDefinitions, this.__depemployee$tableName, this.sectionObjectDetails, this.isLoading, this.dataSource, this.filteredResultList, this.gridSearchRowToggle, this.filterSectionDetail);
        }).catch(error => {
    ...
    ionViewDidEnter() {
        ...
        setTimeout(() => {
            ...
            this.gridIdConfig.setSlickGridPaginationId(slickgridHeaderColumn, this.gridId, "depemployee",
                this.columnDefinitions[this.__depemployee$tableName], document);
            this.listServiceUtils.windowHeight(document);
        }, 100)
    }
    ionViewWillUnload() {
        console.log('unsubscribe in list')
        this.observableListenerUtils.remove(this.tableName_pfm71655, '==');
    }
    addButton_7773871_Onclick() {
        const queryParamsRouting = {
            action: 'Add'
        };
        if (!this.appUtilityConfig.checkPageAlreadyInStack("/menu/depemployee_Entry_Web")) {
            queryParamsRouting['redirectUrl'] = "/menu/depemployee_d_w_list";
        }
