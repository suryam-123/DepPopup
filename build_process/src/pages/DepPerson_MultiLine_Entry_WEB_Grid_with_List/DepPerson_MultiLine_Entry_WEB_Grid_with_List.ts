...
@Component({
    ...
    async saveButtonOnclick(actionId ? ) {
        ...
        if (this.checkParentAndChildSection) {
            ...
            document.getElementById('deppersonalinfo_layout_mode_1').style.display = 'block';
    ...
    editButton_7897324_Onclick() {
        ...
        if (this.isPopUpEnabled) {
            ...
            redirectUrlForNav = "/menu/DepPerson_MultiLine_Entry_WEB_Grid_with_List";
        }
        ...
        if (this.isPopUpEnabled) {
            ...
            if (!this.appUtilityConfig.checkPageAlreadyInStack("/menu/DepPerson_MultiLine_Entry_WEB_Grid_with_List")) {
                navigationParams['redirectUrl'] = "/menu/DepPerson_MultiLine_Entry_WEB_Grid_with_List";
            }
        }
