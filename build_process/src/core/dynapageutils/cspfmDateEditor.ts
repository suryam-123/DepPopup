...
import { destroyObjectDomElementProps, getDescendantProperty, mapFlatpickrDateFormatWithFieldType, mapMomentDateFormatWithFieldType, setDeepValue } from 'angular-slickgrid';
 ...
 */
export class cspfmDateEditor implements Editor {
    ...
    validate(inputValue?: any): EditorValidatorOutput {
        ...
        if (isRequired && elmValue === '') {
            return {
                valid: false,
                msg: errorMsg || "Field is required"
            };
        }
