//  line no 237 - 242 line added columnName to convert special charector to entities and line  242 modified by removing the text() function
// slickgrid 6pac version '2.4.44' angular-slickgrid version 2.30.4
(function ($) {
    // Register namespace
    $.extend(true, window, {
      "Slickgrid": {
          ...
          _gridColumns.forEach(function(e, i, a) {
            if (e.id == columnid) {
              if (e.grouping != null && !$.isEmptyObject(e.grouping)) {
                ...
                columnName = columnName.text().replace(/&/g, '&amp;').
                replace(/</g, '&lt;').
                replace(/>/g, '&gt;').
                replace(/"/g, '&quot;');
                var groupText = $("<div style='display: inline-flex'>" + (columnName.length ? columnName : column) + "</div>");
