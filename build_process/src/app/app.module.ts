...
import { cspfmInterceptor } from 'src/core/utils/cspfmInterceptor';
...
import { cspfmCalendarEventInfoModule } from 'src/core/pages/cspfmCalendarEventInfo/cspfmCalendarEventInfo.module';
import { cspfmCalendarPageModule } from 'src/core/pages/cspfmCalendarPage/cspfmCalendarPage.module';
import { cspfmdocumentuploadconfigurationModule } from 'src/core/pages/cspfmdocumentuploadconfiguration/cspfmdocumentuploadconfiguration.module';
import { cspfmweblookuppageModule } from 'src/core/pages/cspfmweblookuppage/cspfmweblookuppage.module';
import { cspfmSlickgridPopovermodule } from 'src/core/components/cspfmSlickgridPopover/cspfmSlickgridPopover.module';
...
import { EmbeddedModule } from 'src/core/pages/embedded/embedded.module';
import { cspfmMetaCouchDbProvider } from 'src/core/db/cspfmMetaCouchDbProvider';
import { cspfmExecutionCouchDbProvider } from '../core/db/cspfmExecutionCouchDbProvider';
import { cs_status_workflow_historymodule } from 'src/core/components/cs_status_workflow_history/cs_status_workflow_history.module';
import { cs_global_searchmodule } from 'src/core/components/cs_global_search/cs_global_search.module';
import { cspfmGlobalSearchMoreActionPagemodule } from 'src/core/pages/cspfmGlobalSearchMoreActionPage/cspfmGlobalSearchMoreActionPage.module';
...
import { cspfmUrlmodule } from 'src/core/components/cspfmUrl/cspfmUrl.module';
import { cspfmUrl } from 'src/core/components/cspfmUrl/cspfmUrl';
import { cspfmWebActionmodule } from 'src/core/components/cspfmWebAction/cspfmWebAction.module';
import { cspfmWebPopoverActionmodule } from 'src/core/components/cspfmWebPopoverAction/cspfmWebPopoverAction.module';
import { cspfmRecordAssociationmodule } from 'src/core/components/cspfmRecordAssociation/cspfmRecordAssociation.module';
import { cspfmWebAssociationPageModule } from 'src/core/pages/cspfmWebAssociationPage/cspfmWebAssociationPage.module';
import { cspfmRecordAssociationDisplaymodule } from 'src/core/components/cspfmRecordAssociationDisplay/cspfmRecordAssociationDisplay.module';
...
import { cs_conditionalvalidation_toastmodule } from 'src/core/components/cs_conditionalvalidation_toast/cs_conditionalvalidation_toast.module';
import { cs_conditionalvalidation_toast } from 'src/core/components/cs_conditionalvalidation_toast/cs_conditionalvalidation_toast';
...
import { cspfmMoreActionmodule } from 'src/core/components/cspfmMoreAction/cspfmMoreAction.module';
import { cs_status_workflow_bulkapprovalmodule } from 'src/core/components/cs_status_workflow_bulkapproval/cs_status_workflow_bulkapproval.module';
import { cs_status_workflow_bulkapproval } from 'src/core/components/cs_status_workflow_bulkapproval/cs_status_workflow_bulkapproval';
import { NgxMasonryModule } from 'ngx-masonry';
import { BarcodeScanner } from '@awesome-cordova-plugins/barcode-scanner/ngx';
import { cspfmUserAssignmentmodule } from 'src/core/components/cspfmUserAssignment/cspfmUserAssignment.module';
import { cspfmUserAssignmentPopovermodule } from 'src/core/components/cspfmUserAssignmentPopover/cspfmUserAssignmentPopover.module';
import { cspfmCloneMappingInfoModule } from '../core/pages/cspfmCloneMappingInfo/cspfmCloneMappingInfo.module';
...
import { cspfmCustomActionPopoverModule } from 'src/core/components/cspfmCustomActionPopover/cspfmCustomActionPopover.module';
import { cspfmWebworker } from 'src/core/services/cspfmWebworker.service';
import { cspfmHeaderLineUtils } from 'src/core/dynapageutils/cspfmHeaderLineUtils';
import { cspfmRecordAssignmentUtils } from 'src/core/dynapageutils/cspfmRecordAssignmentUtils';
import { cspfmSettingsModule } from 'src/core/pages/cspfmSettings/cspfmSettings.module'
import { cspfmOnDemandFeature } from 'src/core/utils/cspfmOnDemandFeature';
import { cspfmAlertDialogmodule } from 'src/core/components/cspfmAlertDialog/cspfmAlertDialog.module';
...
@NgModule({
  ...
  imports: [
    ...
    ServiceWorkerModule.register('/apps/ngsw-worker.js', { enabled: environment.production, registrationStrategy: 'registerImmediately' })
  ],
  providers: [
    ...
    { provide: HTTP_INTERCEPTORS, useClass: cspfmInterceptor, multi: true }
  ],
